 ...
 * can never diverge — see copilot-instructions.md's "Generative Fix Divergence" note: this
 ...
 * normalization — copilot-instructions.md's Generative Fix Divergence class):
 ...
 * re-derived per site (copilot-instructions.md's Generative Fix Divergence class).
