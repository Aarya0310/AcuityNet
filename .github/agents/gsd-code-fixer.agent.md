...
if [ "$USE_WORKTREES" = "false" ]; then
  ...
  # #2647: create the worktree INSIDE the repo under the same `.github/worktrees/`
  ...
  # `.gitignore` rule for `.github/` (`.gitignore:12`). Uniqueness across
  ...
  wt="$main_repo/.github/worktrees/rf-${padded_phase}-$$-$(date +%s)"
  mkdir -p "$wt"
