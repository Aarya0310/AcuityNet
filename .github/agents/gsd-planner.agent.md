...
Full rules: @.github/gsd-core/references/context-budget.md (Phase Sizing). Read before sizing.
...
Three types: **checkpoint:human-verify (90%)**, **checkpoint:decision (9%)**, **checkpoint:human-action (1% - rare)**. Full "use for" criteria and XML templates for each: @.github/gsd-core/references/checkpoints.md
...
See @.github/gsd-core/references/planner-guidance.md for return formats; gap-closure returns are artifact-based (#3440).
